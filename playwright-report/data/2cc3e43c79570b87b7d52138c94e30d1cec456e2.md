...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    ...
    - main [ref=e10]:
      ...
      - generic [ref=e37]:
        - link "新しいEscrowを作成 暗号通貨を預けて、現金での受け取りを待ちます。 作成する" [ref=e38]:
          - /url: /new
          - heading "新しいEscrowを作成" [level=3] [ref=e39]
          - paragraph [ref=e40]: 暗号通貨を預けて、現金での受け取りを待ちます。
          - generic [ref=e41]: 作成する
        - generic [ref=e42]:
          - heading "既存のEscrowに参加" [level=3] [ref=e43]
          - paragraph [ref=e44]: QRコードをスキャンして、既存のEscrowに参加します。
          - generic [ref=e45]: 参加する
        - link "ログを確認 すべてのEscrowイベントの履歴を表示します。 ログを見る" [ref=e46]:
          - /url: /logs
          - heading "ログを確認" [level=3] [ref=e47]
          - paragraph [ref=e48]: すべてのEscrowイベントの履歴を表示します。
          - generic [ref=e49]: ログを見る
      - generic [ref=e50]:
